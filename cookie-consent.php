...
function egap_cookie_consent_banner() {
    ...
    $show_cookie_consent = isset($egap_settings['egap_show_cookie_consent']) ? $egap_settings['egap_show_cookie_consent'] : '';

    // Only display the cookie consent banner if the option is enabled.
